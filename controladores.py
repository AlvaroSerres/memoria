...
class Ctrl_Pulgar():
    ...
    def explorar(self, camara, mano):
        ...
        # Mueve el servo, haciendo que se cierre 
        # ~90°: pos inicial
        # 60°: primer movimiento
        # 30°: segundo movimiento
        # 0°: tercer movimiento
        for angulo in [60, 30, 0]:
            # "Primitiva" temporal:
            temp = {}
    ...
    def mover(self, punto_objetivo, camara, mano):
        ...
        # Distancias entre primitivas y punto objetivo
        distancias = []
        
        for primitiva in primitivas:
            dist = np.linalg.norm(primitiva["pos_inicial"] - punto_objetivo)
            distancias.append(dist)
        ...
        # OBS: Inicialmente, la más cercana es siempre la primera!
